...
import com.halcyonmobile.composecomponents.component.swipe_to_refresh_with_offset.SwipeToRefreshWithOffset
...
val components = listOf(
    ...
    Component("SwipeRefreshSheet", "A bottom sheet that also supports swipe to refresh") { SwipeToRefreshWithOffset() },
)
